...
set CLOCK_FILES=clock_core clock_math clock_vector clock_matrix clock_texture clock_sprite clock_rect clock_resource_manager clock_render_target clock_color clock_font
set CLOCK_SRCS=
set CLOCK_OBJS=
...
set RPG_FILES=rpg player enemy tile common
set RPG_SRCS=
